...
class SVCFleetSpawner : EveryFrameScript {
    ...
    private fun spawnFactionFleetsUntilLimit(faction: String) {
        var numFleets = countFactionFleets(faction)
    ...
    private fun createFactionFleet(factionId: String, minDP: Int = (Math.random() * 250f).toInt(), name: String? = null) : CampaignFleetAPI? {
