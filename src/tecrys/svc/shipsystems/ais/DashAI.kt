...
class DashAI: ShipSystemAIScript {
    ...
    override fun advance(amount: Float, missileDangerDir: Vector2f?, collisionDangerDir: Vector2f?, target: ShipAPI?) {
        ...
        val collision = CombatUtils.getShipsWithinRange(ship.location, 600f + ship.collisionRadius)
...
//        }
        ...
        if((sys.ammo.toFloat() * threat > DAMAGE_TO_HULL_THRESHOLD * ship.hitpoints) && collision.isNullOrEmpty()){
