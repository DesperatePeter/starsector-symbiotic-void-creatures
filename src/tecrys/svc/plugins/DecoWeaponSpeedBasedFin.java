...
import java.util.List;
    ...
    {  
      ...
      /*     */   private static boolean tentacleCheck(List weapons)
/*     */   {
/*  59 */     boolean returnBoolean = false;
/*  60 */     for (Iterator it = weapons.iterator(); it.hasNext();) {
/*  61 */       Object weaponObject = it.next();
/*  62 */       WeaponAPI weaponIDCheck = (WeaponAPI)weaponObject;
/*     */       
/*  64 */       if ((weaponIDCheck.getId().contains("tentacle")))
/*     */       {
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*  72 */         returnBoolean = true;
/*  73 */         break;
/*     */       }
/*     */       
/*     */ 
/*     */ 
/*  78 */       returnBoolean = false;
/*     */     }
/*     */     
/*  81 */     return returnBoolean;
/*     */   }       
