    ...
    public class DecoWeaponSpeedBasedFin3 implements EveryFrameWeaponEffectPlugin  
    {  
        // Frames per second at 0 speed  
        private static final float MIN_FPS = 3f;  
        // Frames per second at max speed (without stat boosts)  
        private static final float MAX_FPS = 18f;  
