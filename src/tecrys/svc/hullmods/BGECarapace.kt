...
class BGECarapace : BaseHullMod() {
    companion object{
        ...
        private val ALLOWED_HULLMODS = setOf("BGECarapace", "svc_alpha_voidling", "svc_controlcollar_hm",
            ...
            "svc_no_fuel_hm", "svc_more_alphas_hm", "svc_overdamage_res_hm", "svc_shell_vulcanization","sms_masteryHandler","sms_randomModification",
            "sms_engineeringOverride", "sms_npcIndicator1","sms_npcIndicator2","sms_npcIndicator3","sms_npcIndicator4","sms_npcIndicator5",
            "sms_npcIndicator6","sms_npcIndicator7","sms_npcIndicator8","sms_npcIndicator9","sms_npcIndicator10","sms_npcIndicator11",
            "sms_npcIndicator12","sms_npcIndicator13","sms_npcIndicator14","sms_npcIndicator15")
