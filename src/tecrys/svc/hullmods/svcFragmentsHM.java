 ...
 *
 */
public class svcFragmentsHM extends BaseHullMod {
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        if (SHOW_OVERLAY_ON_THREAT_SHIPS || !ship.getHullSpec().hasTag(Tags.THREAT)) {
            //ship.setExtraOverlay(Global.getSettings().getSpriteName("misc", "svc_swarm"));
...
//		}
        ...
        if (ship.isFighter()) {
            ...
            params.minOffset = 600f;
            params.maxOffset = 900f;
            params.generateOffsetAroundAttachedEntityOval = true;
            params.offsetRotationDegreesPerSecond = 15f;
