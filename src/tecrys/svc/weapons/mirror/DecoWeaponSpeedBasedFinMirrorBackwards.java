...
public class DecoWeaponSpeedBasedFinMirrorBackwards extends tecrys.svc.plugins.DecoWeaponSpeedBasedFin implements EveryFrameWeaponEffectPlugin, WeaponEffectPluginWithInit {
...
// or that are left of the centerline and face backwards-or-exactly-to-the-side.
    public DecoWeaponSpeedBasedFinMirrorBackwards() {
        super();
    }
