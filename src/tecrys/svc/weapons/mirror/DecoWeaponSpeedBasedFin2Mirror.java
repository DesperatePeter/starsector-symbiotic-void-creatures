...
public class DecoWeaponSpeedBasedFin2Mirror extends tecrys.svc.plugins.DecoWeaponSpeedBasedFin2 implements EveryFrameWeaponEffectPlugin, WeaponEffectPluginWithInit {
...
// or that are left of the centerline and face backwards-or-exactly-to-the-side.
    public DecoWeaponSpeedBasedFin2Mirror() {
        super();
    }
