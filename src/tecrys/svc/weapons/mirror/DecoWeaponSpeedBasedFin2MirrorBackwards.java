...
public class DecoWeaponSpeedBasedFin2MirrorBackwards extends tecrys.svc.plugins.DecoWeaponSpeedBasedFin2 implements EveryFrameWeaponEffectPlugin, WeaponEffectPluginWithInit {
...
// or that are left of the centerline and face backwards-or-exactly-to-the-side.
    public DecoWeaponSpeedBasedFin2MirrorBackwards() {
        super();
    }
