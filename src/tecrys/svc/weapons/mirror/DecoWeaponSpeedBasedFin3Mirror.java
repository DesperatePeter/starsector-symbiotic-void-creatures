...
public class DecoWeaponSpeedBasedFin3Mirror extends tecrys.svc.plugins.DecoWeaponSpeedBasedFin3 implements EveryFrameWeaponEffectPlugin, WeaponEffectPluginWithInit {
...
// or that are left of the centerline and face backwards-or-exactly-to-the-side.
    public DecoWeaponSpeedBasedFin3Mirror() {
        super();
    }
