...
public class AcidJetEffectOnHit extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public static float TOTAL_DAMAGE = 50;

	public static Color SHROUD_COLOR = new Color(168,199,77, 40);
	public static Color SHROUD_GLOW_COLOR = new Color(92, 85, 24, 150);

	public AcidJetEffectOnHit() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		AcidJetEffectOnHit effect = new AcidJetEffectOnHit(projectile, (ShipAPI) target, offset);
	...
	public static class ParticleData {
		...
		public Color color = randomizeColor(SHROUD_COLOR, 50);
	...
	public AcidJetEffectOnHit(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
