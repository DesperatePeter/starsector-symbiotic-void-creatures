...
public class tentacle_engine_03 extends BaseCombatLayeredRenderingPlugin implements EveryFrameWeaponEffectPlugin {
	Vector2f center;
...
//		if(!weapon.getShip().isAlive())return;
		...
		List<SegmentData> points = tentacle_render.makeSegmentsBezierCurve(
				...
				size.x/2f,//float offsetWaveformSize
		...
		tentacle_render.renderQuadStrip(new tentacle_render.renderData(
				...
				32, new Vector2f(0,0), Color.WHITE,0.3f,0, CombatEngineLayers.CONTRAILS_LAYER
